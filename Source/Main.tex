  ...
  \ifthenelse{\boolean{hdm}}
  {
    \begin{titlepage}
      \begin{centering}
        ...
        Masterarbeit im Studiengang \\ \textbf{\Large Computer Science and Media}
        ...
        vorgelegt von \\ \textbf{\Large Manuel Maier} \\ Matrikelnummer 28535

        an der \\ \textbf{\Large Hochschule der Medien Stuttgart}

        am \\ \textbf{\Large 14.11.2016}

        zur Erlangung des akademischen Grades eines \\ \textbf{\Large Master of Science (M.Sc.)}
      ...
      \begin{tabu} to \linewidth { l X }
        Erstprüfer: & \textbf{Prof. Dr. Stefan Radicke}\\
        Zweitprüfer: & \textbf{Patrick Bader, M.Sc.}
      \end{tabu}
    \end{titlepage}
  }
  {
