...
\label{cha:EnvSetup}
  ...
  \label{sec:VulkanHeader}
    Once it has been made sure that the current platform supports Vulkan, \todo{remove or fill}
  ...
  \label{sec:VulkanLoader}
    ...
    \todo[inline]{Explain differences between explicit and implicit layers a bit more?}

    \todo[inline]{Besides layers there are also extensions.}
  ...
  \label{sec:EnvShaders}
    ...
    \todo{fill caption, move to separate file}
