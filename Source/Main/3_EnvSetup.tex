...
\label{cha:EnvSetup}
  ...
  \label{sec:VulkanLoader}
    ...
    \todo[inline]{Explain layers here now??}

    \todo[inline]{Example for an implicit layer: Steam layer with UI overlay. Contrast it maybe with RenderDoc or validation layers.}
