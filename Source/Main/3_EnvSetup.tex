...
\label{cha:EnvSetup}
  ...
  \label{sec:VulkanLoader}
    ...
    \lstinputlisting[
      ...
      emphstyle={\underbar},
      emph={[2]ppEnabledLayerNames,enabledLayerCount},
      emphstyle={[2]\bfseries\underbar}
    ]
