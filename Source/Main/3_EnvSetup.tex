...
\label{cha:EnvSetup}
  ...
  \label{sec:DebuggingAndProfiling}
    ...
    At the time of writing, no Vulkan-specific GPU profiling tool is known to the author \todo{Remove "of this work"?}of this work.
    ...
    \todo{Is this comprehensive enough?}This gives applications the opportunity to implement their own internal \gls{gpu} profiling system by taking time samples at application-defined points within command buffers.
