...
\label{cha:EnvSetup}
  ...
  \label{sec:VulkanLoader}
    ...
    \todo[inline]{Layers are discovered by the loader via the registry on Windows and in special directories on Unix based platforms. Files discovered there are always in JSON format and provide information about the library location and more.}
