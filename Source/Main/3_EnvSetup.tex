...
\label{cha:EnvSetup}
  ...
  \label{sec:EnvShaders}
    ...
    \todo{Describe what exactly is required. layout=N, binding=N, set=N, \#extensionm, ...}
  ...
  \label{sec:DebuggingAndProfiling}
    ...
    It is also possible that new tools dedicated to Vulkan may be developed by \acrlongpl{ihv}.
