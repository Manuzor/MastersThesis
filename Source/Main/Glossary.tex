...
\newacronym{ihv}{IHV}{\firstchar{I}ndependent hardware vendor}
...
{
  name={OpenGL},
  description={Open Graphics Library. A cross-platform \gls{api} for rendering with hardware acceleration}
}

\newglossaryentry{gles}
{
  name={OpenGL ES},
  description={OpenGL for Embedded Systems}
}
