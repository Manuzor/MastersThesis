...
\label{cha:VulkanOverview}
  ...
  \label{sec:RenderPassesOverview}
    \todo[inline]
    {
      Explain subpasses and their relationship with framebuffers, and pipelines.
      Mention render pass instances that contain other state.
      Check ``Vulkan in 30 Minutes'' for brief explanations.
    }
    \tbd

    \begin{figure}
      \centering
      % \missingfigure{Main/Images/RenderPassOverview}
  ...
  \label{sec:Pipelines}
    ...
    \begin{figure}
      \centering
      \missingfigure{Main/Images/GraphicsPipeline}
      % \includegraphics[width=\textwidth]{Main/Images/GraphicsPipeline}
    ...
    \label{subsec:PipelineCache}
      ...
      % See figure~\ref{fig:PipelineCache} for an illustration of this process.
