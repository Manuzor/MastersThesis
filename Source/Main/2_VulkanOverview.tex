...
\label{cha:VulkanOverview}
  ...
  \label{sec:LayersAndExtensions}
    ...
    Layers can only be created on the instance-level. Until version 1.0.a.b\todo{Find out the exact version.}, the \gls{application} was able to create device-level layers, but these were deprecated in Vulkan version 1.0.c.d.
