...
\label{cha:VulkanOverview}
  ...
  \label{sec:MemoryManagement}
    \todo[inline]{Allocate memory separately and then binding it to resources. Decoupled on purpose for custom management and reuse.}
  ...
  \label{sec:CommandBuffers}
    \todo[inline]
    {
      Have their own state. Used with vkCmd commands. Are submitted to a queue. Can be executed out of order.
    }
    \lipsum
