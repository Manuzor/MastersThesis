...
\label{cha:RenderPipeline}
  ...
  \label{sec:RenderingSetup}
    ...
    \subsection{Device and Queue Setup}
      ...
      \lstinputlisting[
        ...
        caption={Definition of a queue create info for a single queue with the highest priority value.},
        style=MyCppFloat,
        firstline=10,
        lastline=14,
        float
    ...
    \label{subsec:GraphicsPipelineSetup}
      ...
      \label{sss:GraphicsPipelineShaderStages}
        ...
        \lstinputlisting[
          ...
          caption={Setup of vertex and fragment shader stages. Shader code is loaded from two different files.},
          style=MyCppFloat,
          firstline=4,
          lastline=10,
          float
        ...
        \lstinputlisting[
          ...
          caption={Simple vertex shader that transforms a three-dimensional position value using a model-view-projection matrix.},
          style=MyCppFloat,
          firstline=4,
          lastline=8,
          float
        ...
        \lstinputlisting[
          ...
          caption={Fragment shader that yields a constant color value.},
          style=MyCppFloat,
          firstline=13,
          lastline=16,
          float
      ...
      \label{sss:VertexInputStateSetup}
        ...
        \lstinputlisting[
          ...
          caption={Defining a vertex binding with the size of a vertex specified as $3\cdot sizeof(float)=12$ bytes.},
          style=MyCppFloat,
          firstline=15,
          lastline=17,
          float
        ...
        \lstinputlisting[
          ...
          caption={Defining a vertex attribute consisting of three floating point values.},
          style=MyCppFloat,
          firstline=19,
          lastline=23,
          float
        ...
        \lstinputlisting[
          ...
          caption={Input assembly state setup causing the graphics pipeline to treat input data as a list of triangles.},
          style=MyCppFloat,
          aboveskip=\bigskipamount,
          firstline=34,
          lastline=35
      ...
      \label{sss:ViewportState}
        ...
        \lstinputlisting[
          ...
          caption={Dynamic state setup for viewport and scissor data.},
          style=MyCppFloat,
          aboveskip=\bigskipamount,
          % float,
          firstline=40,
        ...
        \lstinputlisting[
          ...
          caption={Viewport setup for a single viewport and scissor, respectively.},
          style=MyCppFloat,
          aboveskip=\bigskipamount,
          % float,
          firstline=48,
      ...
      \subsubsection{Rasterization State}
        ...
        \lstinputlisting[
          ...
          caption={Rasterization state setup producing filled polygons without culling.},
          style=MyCppFloat,
          aboveskip=\bigskipamount,
          % float,
          firstline=55,
      ...
      \label{sss:MultisampleState}
        ...
        \lstinputlisting[
          ...
          caption={Multisample state setup with only a single sample.},
          style=MyCppFloat,
          aboveskip=\bigskipamount,
          % float,
          firstline=62,
      ...
      \subsubsection{Depth Stencil State}
        ...
        \lstinputlisting[
          ...
          caption={Typical depth-stencil state setup enabling depth testing, discarding fragments that are occluded by other fragments with a higher depth value.},
          style=MyCppFloat,
          % aboveskip=\bigskipamount,
          float,
          firstline=68,
      ...
      \subsubsection{Color Blend State}
        ...
        \lstinputlisting[
          ...
          caption={Color blend state setup that enables blending completely applying to all color channels.},
          style=MyCppFloat,
          aboveskip=\bigskipamount,
          % float,
          firstline=77,
      ...
      \label{sss:RenderPassSetup}
        ...
        \lstinputlisting[
          ...
          caption={Setup of render pass attachments. The color attachment is sampled once, cleared when loaded, and properly stored after the render pass, remaining in presentable image layout afterwards. The depth attachment is also sampled once, cleared when loaded, and discarded after the render pass, always remaining in the same image layout.},
          style=MyCppFloat,
          firstline=88,
          lastline=101,
          float
        ...
        \lstinputlisting[
          ...
          caption={Setup of a single subpass with a color and depth attachment reference corresponding to those presented in listing~\ref{lst:RenderPassAttachmentsSetup}.},
          style=MyCppFloat,
          firstline=103,
          lastline=115,
          float
  ...
  \label{sec:BuildCommandBuffers}
    ...
    \lstinputlisting[
      ...
      caption={Creation of a command pool and allocation of a primary command buffer.},
      style=MyCppFloat,
      firstline=1,
      lastline=9,
      float
  ...
  \label{sec:RenderLoop}
    ...
    \lstinputlisting[
      ...
      caption={Updating shader data of all rendered scene objects using mapped memory regions.},
      style=MyCppFloat,
      firstline=7,
      lastline=19,
      float
    ...
    \lstinputlisting[
      ...
      caption={Acquiring the next available image from a swapchain with a large timeout value.},
      style=MyCppFloat,
      firstline=21,
      lastline=29,
      float
    ...
    \lstinputlisting[
      ...
      caption={Presenting a swapchain image on a specific queue using two semaphores for synchronization.},
      style=MyCppFloat,
      firstline=47,
      lastline=57,
      float
