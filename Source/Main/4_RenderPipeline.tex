    ...
    \label{subsec:GraphicsPipelineSetup}
      ...
      \label{sss:RenderPassSetup}
        ...
        \lstinputlisting[
          ...
          caption={Setup of the single subpass with a color and depth attachment reference corresponding to those presented in listing~\ref{lst:RenderPassAttachmentsSetup}.},
          style=MyCppFloat,
          firstline=103,
          lastline=115,
          float
