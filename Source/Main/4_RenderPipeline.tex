...
\label{cha:RenderPipeline}
  ...
  \label{sec:RenderingSetup}
    ...
    \label{subsec:GraphicsPipelineSetup}
      ...
      \label{sss:ViewportState}
        ...
        In this chapter, only one of each is used that \todo{encompass?}include the entire framebuffer, respectively.
    ...
    \label{sub:ActualGraphicsPipelineCreation}
      In the previous section\todo{`sections' if they are moved up by a level}, the graphics pipeline was prepared to be created.
      ...
      In this case a \lstinline{nullptr} value is passed, thus no pipeline cache is used.
  ...
  \label{sec:RenderLoop}
    ...
    \todo[fancyline]{Show how semaphores are created? It's not really relevant...}
