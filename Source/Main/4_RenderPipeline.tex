...
\label{cha:RenderPipeline}
  ...
  \label{sec:RenderingSetup}
    ...
    \label{subsec:GraphicsPipelineSetup}
      ...
      \label{sss:GraphicsPipelineLayout}
        ...
        \lstinputlisting[
          ...
          lastline=15,
          float,
          emph={vkCreateDescriptorSetLayout, vkCreatePipelineLayout}
        ]
        {Main/Listings/GraphicsPipelineLayout.cpp}
    ...
    \subsection{Creating Scene Objects}
      ...
      \todo[inline]{Descriptor set LAYOUT has already been created for the pipeline layout. Explain and show the actual descriptor set here.}
      \tbd
