...
\label{cha:Introduction}
  ...
  \section{High Level Graphics Workflow}
    ...
    \todo[inline,color=blue!60]{Mention compute shader}
  ...
  \section{The Vulkan Graphics and Compute API}
    ...
    \begin{description}
      ...
      \item[Reduce Driver Complexity]\proofread By passing more responsibility on to the application, driver implementations can be simpler.
