...
\label{cha:Conclusion}
  ...
  \todo[inline,color=blue!60]{Future work. Based on thesis, what's the next step for learning Vulkan or use it in an application?}
  \todo[inline,color=blue!60]{Mention why Vulkan is so complex: App has to do stuff the driver did before in OpenGL, mention resource configuration and pipeline setup, more required knowledge about what the GPU actually does, etc...}
  \todo[inline,color=blue!60]{Mention Doom with both OpenGL and Vulkan backends and how Vulkan yields significantly better performance.}
